  ...
  return (
    <section className="py-20 overflow-hidden relative">
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="relative" aria-roledescription="carousel" aria-label="User testimonials">
          {/* Left shadow overlay */}
          <div className="absolute top-0 left-0 h-full w-32 bg-gradient-to-r from-black/20 to-transparent z-10"></div>
          
          {/* Right shadow overlay */}
          <div className="absolute top-0 right-0 h-full w-32 bg-gradient-to-l from-black/20 to-transparent z-10"></div>
          ...
          >
            ...
            <div className="flex justify-center">
              <TestimonialCard review={reviews[activeIndex]} />
            </div>
          </div>
          
          {/* Navigation controls */}
          <div className="flex items-center justify-between absolute top-1/2 left-4 right-4 -mt-8 z-20">
            <button
              onClick={prevSlide}
              className="bg-gray-800/70 hover:bg-gray-800 transition-colors p-3 rounded-full text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
          ...
          {/* Dot navigation - properly indicating current card */}
