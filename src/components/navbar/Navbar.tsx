...
const Navbar = () => {
  ...
  return (
    <nav className='fixed inset-x-0 top-4 z-40 mx-auto flex h-[60px] max-w-5xl items-center justify-between rounded-2xl bg-gray-700/30  shadow-sm saturate-100  duration-500   w-full border-b  backdrop-blur-lg transition-all'>
