...
const MediaFeatures = () => {
  ...
  return (
    <div ref={ref1} className={`transition-opacity ease-in duration-1000 ${isVisible1 ? "opacity-100" : "opacity-0"}`}>
      <h1 className='text-3xl md:text-5xl font-bold text-center mt-20 my-8 bg-gradient-to-r from-pink-400 to-blue-500 text-transparent bg-clip-text'>Media Features: </h1>
