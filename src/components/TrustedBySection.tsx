...
const TrustedBySection = () => {
  ...
  return (
    <div ref={ref1} className={`transition-opacity ease-in duration-1000 ${isVisible ? "opacity-100" : "opacity-0"}`}>
      <h1 className='mt-60 md:mt-14 font-bold text-2xl md:text-5xl mb-7 text-gray-700 dark:text-zinc-200 text-center'>Trusted by <span className='bg-gradient-to-r from-cyan-500 to-pink-500 bg-clip-text text-transparent'>500+ Companies</span> </h1>
