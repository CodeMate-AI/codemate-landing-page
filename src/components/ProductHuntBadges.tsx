    ...
    <div ref={ref1} className={`transition-opacity ease-in duration-1000 ${isVisible1 ? "opacity-100" : "opacity-0"}`}>
      <div className="max-w-6xl mt-12 mx-auto rounded-3xl bg-gradient-to-r from-green-100 to-green-50 px-6 py-16 text-center">
        <div className="relative m-auto max-w-xl">
          ...
          <a href="#" target="_blank">
            <h2
              ...
              <span className="font-bold underline underline-offset-2 dark:text-gray-700">absolute 5/5</span>
            </h2>
          </a>
          <p className="mt-4 font-dm-sans text-desktop-paragraph text-slate-body dark:text-gray-700">Reviews are from paid customers and Product
            Hunt community</p>
          <svg className={`absolute top-24 -left-10 hidden h-36 ${theme === "dark" ? "fill-violet-600" : "fill-black"}  text-slate-body sm:block md:-left-14 md:h-44`}
          ...
          <svg className={`absolute top-24 -right-10 hidden h-36 ${theme === "dark" ? "fill-violet-600" : "fill-black"} text-slate-body sm:block md:-right-14 md:h-44`}
        ...
        <div className="mt-6 flex flex-col items-center justify-center space-y-3">
          ...
          <a href="https://www.producthunt.com/posts/codemate-ai?utm_source=badge-featured&amp;utm_medium=badge&amp;utm_souce=badge-codemate-ai" className='mt-6 gap-5 my-5 ' target="_blank">
            <img src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=392150&amp;theme=light" alt="CodeMate AI - Grammarly for Programmers: Auto-GPT for fixing errors | Product Hunt" width="250" height="54" />
          </a>
        </div>
